...
// 自定义错误
$.validate.setRule("adAmt", function(value, element, param) {
    return /^(-)?(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/.test(value);
}, '请输入正确的金额。');

//自定义错误
$.validate.setRule("idcard", function(value, element, param) {
