...
package com.dyb.platforms.fixfunds.services.utils.core.dao;
...
public class IbatisBaseStatement {
    ...
    public IbatisBaseStatement() {
    }

    public String getInsertStatementId() {
        return this.insertStatementId;
    }
    ...
    public String getGetHasDetailStatementId() {
        return this.getHasDetailStatementId;
    }
    ...
    public String getGetNoDetailStatementId() {
        return this.getNoDetailStatementId;
    }
    ...
    public String getWhereDeleteStatementId() {
        return this.whereDeleteStatementId;
    }
    ...
    public String getQueryCountStatementId() {
        return this.queryCountStatementId;
    }
    ...
    public String getQueryHasDetailListStatementId() {
        return this.queryHasDetailListStatementId;
    }
    ...
    public String getQueryNoDetailListStatementId() {
        return this.queryNoDetailListStatementId;
    }
